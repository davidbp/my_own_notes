	...
	main()
{
    ...
    graph G0 = graph_read( "./input_data/graph0.in" );
    ...
    graph G1 = graph_read( "./input_data/graph1.in" );
	...
	//  Read graph from graph0.in to adjacencies lists G0
    graph G2 = graph_read( "./input_data/graph2.in" );
	...
	//  Read graph from graph0.in to adjacencies lists G0
    graph G3 = graph_read( "./input_data/graph3.in" );
