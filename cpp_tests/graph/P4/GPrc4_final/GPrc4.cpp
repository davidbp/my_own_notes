...
int main()
{
    ...
    //  Read graph from graph0.in to adjacencies lists G0
    graph G2 = graph_read("./input/graph2.in");
    fout.open("./results/graph2.out");
    graph_write(G2, fout);
    ...
    //  Read graph from graph0.in to adjacencies lists G0
    graph G3 = graph_read("./input/graph3.in");
    fout.open("./results/graph3.out");
    graph_write(G3, fout);
    ...
    wgraph WG0 = wgraph_read("./input/wgraph0.in");
    fout.open("./results/wgraph0.out");
    ...
    wgraph WG1 = wgraph_read("./input/wgraph1.in");
    fout.open("./results/wgraph1.out");
    ...
    wgraph WG2 = wgraph_read("./input/wgraph2.in");
    fout.open("./results/wgraph2.out");
    wgraph_write(WG1, fout);
    ...
    wgraph WG3 = wgraph_read("./input/wgraph3.in");
    fout.open("./results/wgraph3.out");
    ...
    wgraph WD = wgraph_read("./input/WD.in");
    fout.open("./results/WD.out");
    ...
    wgraph WI = wgraph_read("./input/WI.in");
    fout.open("./results/WI.out");
    ...
    wgraph Cities1 = wgraph_read("./input/cities1.in");
    fout.open("./results/cities1.out");
    ...
    wgraph Cities2 = wgraph_read("./input/cities2.in");
    fout.open("./results/cities2.out");
