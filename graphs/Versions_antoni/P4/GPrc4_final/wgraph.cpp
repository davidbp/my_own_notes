...
//
 wgraph wgraph_complete( vertex n, weight Mw )
 {    
    wgraph WKn( n );
...
//
 wgraph wgraph_bipartite_complete( vertex n1, vertex n2, weight Mw )
 {    
    wgraph WKn1n2( n1+n2 );
...
//
 wgraph wgraph_cycle( vertex n, weight Mw )
 {    
    wgraph WCn( n );
...
//
 wgraph wgraph_star( vertex n, weight Mw )
 {    
    wgraph WSn( n+1 );
	for( vertex v = 0; v < n; v++ ) {
        weight w = rand()%Mw+1;
...
//  to weighted adjacencies lists (wgraph): WWn
//
 wgraph wgraph_wheel( vertex n, weight Mw )
 {    
    wgraph WWn( n+1 );
	for( vertex v = 0; v < n; v++ ) {
        weight w = rand()%Mw+1;
