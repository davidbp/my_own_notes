...
//
 graph
    graph_bipartite_complete( size_t n1, size_t n2 )
{    
    graph Kn1n2( n1+n2 );
...
//
 graph
    graph_king( size_t n1, size_t n2 )
{    
    graph Kgn1n2( n1*n2 );
...
//
 graph
    graph_knight( size_t n1, size_t n2 )
{    
    graph Ktn1n2( n1*n2 );
    for( size_t i1=0; i1<n1; i1++) 
        for( size_t i2=0; i2<n2; i2++ ) {
...
//
 graph
    graph_rook( size_t n1, size_t n2 )
{    
    graph Rkn1n2( n1*n2 );
    for( size_t i1=0; i1<n1; i1++) 
        for( size_t i2=0; i2<n2; i2++ ) {
...
//
 graph
    graph_bishop( size_t n1, size_t n2 )
{    
    graph Bpn1n2( n1*n2 );
    for( size_t i1=0; i1<n1; i1++) 
        for( size_t i2=0; i2<n2; i2++ ) {
...
//  - degrees and sorted degrees
  void 
	graph_write2( graph& G, size_t n1, size_t n2, ofstream& fout )
{    
//  Vertices number 
	vertex vn = G.size();
//  Count edges number from adjacencies lists
