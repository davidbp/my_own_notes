...
class AgentState:
  ...
  def __str__( self ):
    if self.isPacman:
      ...
      return "Ghost: " + str( self.configuration ) + str(" Scared" if self.scaredTimer > 0 else " NotScared")  ### ERM
  ...
  def getScared(self):  ### ERM
    if self.isPacman:
      return None
    else:
      return (True if self.scaredTimer > 0 else False)
...
class GameStateData:
  ...
  def __str__( self ):
    ...
    for agentState in self.agentStates:
      ...
      if agentState.isPacman:
        ...
        agent_scaredTimer = agentState.scaredTimer
        map[x][y] = self._ghostStr( agent_dir, agent_scaredTimer )
  ...
  def _ghostStr( self, dir, scaredTimer ):
    if scaredTimer > 0:  ### ERM
      return 'S'
    return 'G'
    if dir == Directions.NORTH:
      return 'M'
  ...
  #def ghostDistances( self ):  ### ERM
  #  x = [i for i in range(len(self.agentStates)-1)]
  #  return x
